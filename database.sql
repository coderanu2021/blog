...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 16, 2025 at 07:34 AM
...
INSERT INTO `tbl_user` (`id`, `name`, `email`, `password`, `phone_no`, `profile_photo`, `role`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Admin', 'admin@example.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', NULL, NULL, 'admin', 1, '2025-05-31 05:23:58', '2025-05-31 05:23:58'),
(2, 'test', 'test@gmail.com', '$2y$10$T9oEEmtvq7HmJ9XMGSYjzekGEM0WKV40kwa.7L7/dfvYeEcxXNMQe', '123456789', NULL, 'admin', 1, '2025-06-16 04:44:42', '2025-06-16 04:53:17');
COMMIT;
